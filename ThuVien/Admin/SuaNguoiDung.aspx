<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SuaNguoiDung.aspx.cs" Inherits="ThuVien.Admin.SuaNguoiDung" %>
        ...
        <div id="main">
          ...
          <!-- End Box Head -->
            <!-- Form -->
                    <div class="form">
                        ...
                        <p>
                            ...
                            <asp:TextBox ID="txtUserName" runat="server" CssClass="field size1" ReadOnly="True"></asp:TextBox>
                        </p>
                        <p>
                            <span class="req">
            ...
            <div class="buttons">
                ...
                <asp:Button ID="btnSua" runat="server" Text="Cập nhật người dùng" CssClass="auto-style3" OnClick="btnSua_Click" ForeColor="#00CC00" />
            </div>
            <!-- End Form Buttons -->
        </div>
            </div>
