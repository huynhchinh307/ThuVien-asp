<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ThemSach.aspx.cs" Inherits="ThuVien.Admin.ThemSach" %>
            ...
            <div id="content2">
                ...
                <div class="box">
                    ...
                    <div class="form">
                        ...
                        <p>
                            <span class="req">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Bạn chưa chọn hình!" ForeColor="Red" ControlToValidate="fhinh"></asp:RequiredFieldValidator></span>
                            <label>Hình</label>
                    ...
                    <div class="buttons">
                        ...
                        <asp:Button ID="btnDangBai" runat="server" Text="Đăng sách" CssClass="button" OnClick="btnDangSach_Click" />
                    </div>
                    <!-- End Form Buttons -->
                </div>
            </div>
