<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SuaTaiLieu.aspx.cs" Inherits="ThuVien.Admin.SuaTaiLieu" %>
<%@Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor"%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Thư viện - Sửa tài liệu</title>
</asp:Content>
        ...
        <div id="main">
          ...
          <!-- End Box Head -->
            ...
            <div class="buttons">
                ...
                <asp:Button ID="btnSuaTaiLieu" runat="server" Text="Sửa Tài Liệu" CssClass="button" OnClick="btnSuaTaiLieu_Click" />
            </div>
            <!-- End Form Buttons -->
        </div>
            </div>
